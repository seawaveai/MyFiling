...
* A:Socket套接字概述：  // Socket相对于是码头,IO流相对于是船
...
C:\Users\dell5420ahl\Desktop\eclipse\day24\bin   java day26.Demo02_send
###26.07_网络编程(UDP传输优化)
* 接收端Receive
		...
		while(true) {
			...
			byte[] arr = packet.getData();			//存在arr字节数组中
			int len = packet.getLength();			//获得有效字节个数
