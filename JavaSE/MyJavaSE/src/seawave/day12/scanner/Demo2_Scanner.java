...
public class Demo2_Scanner {
	...
	/**
	 * A:两个常用的方法： public int nextInt():获取一个int类型的值 public String
	 * nextLine():获取一个String类型的值 B:案例演示 a:先演示获取多个int值，多个String值的情况
	 * 
	 * b:再演示先获取int值，然后获取String值出现问题
	 * 
	 * c:问题解决方案 第一种：先获取一个数值后，在创建一个新的键盘录入对象获取字符串。
	...
	public static void main(String[] args) {
		 ...
		 * System.out.println("请输入第二个整数:"); int j = sc.nextInt();
		 ...
		 * System.out.println(i); System.out.print("11111111111");
		 * System.out.print(line2); System.out.println("2222222222222");
		 */

		/*
		 * 解决方案 : 1,创建两次对象,但是浪费空间
